...
[1] = LAYOUT_ansi(
  ...
  XXXXXXX,XXXXXXX,XXXXXXX,KC_PGDN,XXXXXXX,XXXXXXX,KC_LEFT,KC_DOWN,KC_UP,KC_RGHT,XXXXXXX,XXXXXXX,        _______, BL_STEP, \
  _______,XXXXXXX, KC_DEL,XXXXXXX,XXXXXXX,C(KC_LEFT),XXXXXXX,KC_MUTE,KC_VOLD,KC_VOLU,KC_BSLS,_______, KC_PGUP, BL_BRTG, \
